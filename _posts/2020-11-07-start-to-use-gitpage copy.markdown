...
![img](https://yinyang.space/img/create_github_repo.png)

### 1-2 修改repository的Setting
找到Repository的Setting tab页面，如下图：
![img](https://yinyang.space/img/20201108_github_setting.png)


向下一直拖动到GitHub Pages页面，启用GitPages，这里可以设置GitPages使用哪个分支，修改显示的主题风格，以及修改为自定义的域名。

![img](https://yinyang.space/img/20201108_github_page_setting.png)
...
![img](https://yinyang.space/img/20201108_github_test_index.png)
...
![](https://yinyang.space/img/20201108_jekyll_install.png)
...
![img](https://yinyang.space/img/20201108_jekyll_local_server.png)

使用浏览器访问一下，可以看到Jekyll为我们生成的页面：
![img](https://yinyang.space/img/20201108_local_jekyll_server_started.png)
...
![img](https://yinyang.space/img/20201110_qiniu_new_ods.png)
...
![](https://yinyang.space/img/20201110_qiniu_miyao.png)



![img](https://yinyang.space/img/20201110_qiniu_aksk.png)
...
![](https://yinyang.space/img/20201110_qiniu_workflow_hotkey.png)

修改一下参数配置，设置七牛的AK，SK和bucket等参数。
![img](https://yinyang.space/img/20201110_qiniu_workflow_config.png)

![](https://yinyang.space/img/20201110_qiniu_workflow_setting.png)

这里在执行的时候报错了，调试发现设置qshell账户的shell命令行参数数量不对，因为之前已经设置过了，这里就直接注释掉了，速度还能快一些。
![](https://yinyang.space/img/20201110_qiniu_uploadworkflow.png)
...
![img](https://yinyang.space/img/20201111_change_theme.png)
...
![](https://yinyang.space/img/20201111_document_directory.png)
...
![](https://yinyang.space/img/20201110_tx_domain_setting.png)

CNAME修改后一般需要十分钟左右才能生效
![](https://yinyang.space/img/20201110_tx_domain_cname.png)

在GitPages的setting中也将域名修改为自定义域名
![](https://yinyang.space/img/20201110_gitpage_custom_domain.png)

另外，由于七牛的测试域名只能使用30天，所以这里把七牛云空间也一并修改为自定义域名，修改方式也是在腾讯云的管理控制台里面把域名的CNAME修改为七牛云提供的CNAME即可。

![](https://yinyang.space/img/20201110_qiniu_domain_cname.png)
