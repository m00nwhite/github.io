...
![](https://yinyang.space/img/20201127_django2_1.png)
...
![](https://yinyang.space/img/20201127_django2_2.png)



在命令行中运行`python3 manage.py migrate` 来创建表结构
![](https://yinyang.space/img/20201127_django2_3.png)

执行成功后生成了这些表结构
![](https://yinyang.space/img/20201127_django2_02.png)
...
```
![](https://yinyang.space/img/20201127_django2_4.png)
...
```
![](https://yinyang.space/img/20201127_django2_5.png)

数据库上也可以看到已经生成了新的数据表：TestModel_test，表名的组成结构为：应用名_类名（如：TestModel_test）
![](https://yinyang.space/img/20201127_django2_7.png)
...
![](https://yinyang.space/img/20201127_django2_8.png)

登陆数据库查看：
![](https://yinyang.space/img/20201127_django2_9.png)
...
```
![](https://yinyang.space/img/20201127_django2_01.png)
