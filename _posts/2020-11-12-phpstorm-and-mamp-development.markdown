...
![](https://yinyang.space/img/20201121_MAMP0.png)

这里保留默认配置
![](https://yinyang.space/img/20201121_MAMP1.png)

修改Apache默认的端口为80，Nginx为8000，MySQL为3316
![](https://yinyang.space/img/20201121_MAMP2.png)
...
![](https://yinyang.space/img/20201121_phpstorm1.png)
...
![](https://yinyang.space/img/20201121_mamp3.png)

这样在phpstorm中就可以使用PHPStorm中的preview按钮快速在浏览器中预览页面效果了。
![](https://yinyang.space/img/20201121_mamp4.gif)
...
![](https://yinyang.space/img/20201121_mbp1.png)

效果：
![](https://yinyang.space/img/20201121_mbp2.gif)
